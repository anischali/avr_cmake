...
add_compile_options(-I/usr/lib/avr/include -DF_CPU=${AVR_F_CPU_CLK_SPEED_HZ} -ggdb -Os -g3 -Wall -c -fmessage-length=0 -ffunction-sections -fdata-sections -mmcu=${AVR_PROJECT_DEVICE})
add_link_options(-mmcu=${AVR_PROJECT_DEVICE} -Xlinker -Map=${AVR_PROJECT_NAME}.map -Xlinker)
